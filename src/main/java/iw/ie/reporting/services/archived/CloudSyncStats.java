...
@Component
public class CloudSyncStats implements Command {
	...
	private void displayEntireTree(CmisObject cmisObject) {
		if (cmisObject instanceof Folder) {
			...
			CloudContent content = null;
			content = repo.findOne(nodeRef);
			if (content == null) {
				...
				content = new CloudContent(nodeRef, path, document.getName(), checkSum, document.getCreatedBy(), document.getLastModifiedBy(), document.getContentStreamLength());
